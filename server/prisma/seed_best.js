      ...
      data: [
        {
          ...
          insight_val: { behavior: student.behavior, avg_study_hour_hint: student.behavior === "nightowl" || student.behavior === "reflective" ? "malam" : "pagi/siang", completion_ratio: completionRatio },
        },
        {
          user_id: student.id,
          insight_key: "learning_summary",
          insight_val: { enrolled_courses: enrollCount, completed_courses: isCompleted ? 1 : 0, last_course: course.name, note: `Histori dibuat untuk profil ${student.behavior}.` },
        },
      ],
    });
  }
